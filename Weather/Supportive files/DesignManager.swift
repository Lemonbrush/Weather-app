...
struct DesignManager {
    ...
    static func getStandartGradientColor(withStyle style: GradientColors) -> [CGColor] {
        switch style {
        case .day: return [UIColor(red: 68/255, green: 166/255, blue: 252/255, alpha: 1).cgColor, UIColor(red: 114/255, green: 225/255, blue: 253/255, alpha: 1).cgColor]
        case .fog: return [UIColor.clear.cgColor]
        case .night: return [UIColor(red: 9/255, green: 7/255, blue: 40/255, alpha: 1).cgColor, UIColor(red: 30/255, green: 94/255, blue: 156/255, alpha: 1).cgColor]
