...
class SettingsTableViewController: UIViewController {
    ...
    private func setUpConstraints() {
        ...
        // TemperatureCell
        temperatureCellStackView.topAnchor.constraint(equalTo: temperatureCell.contentView.topAnchor,
                                                      constant: 10).isActive = true
        temperatureCellStackView.bottomAnchor.constraint(equalTo: temperatureCell.contentView.bottomAnchor,
                                                         constant: -10).isActive = true
        temperatureCellStackView.leadingAnchor.constraint(equalTo: temperatureCell.contentView.leadingAnchor,
                                                          constant: 20).isActive = true
        temperatureCellStackView.trailingAnchor.constraint(equalTo: temperatureCell.contentView.trailingAnchor,
                                                           constant: -20).isActive = true
